...
f.itemCondition as itemCondition, COUNT(*) as totalItems,
...
CAST(itemDateCreated as string) as ds
FROM
...
GROUP BY cast(itemDateCreated as string), siteId, domainId, clientId, itemCondition
