SELECT 
	...
	jet(event_data, 'detailed_errors[different_inventory_declared]') as different_inventory_declared,
	jet(event_data, 'detailed_errors[different_sku_declared]') as different_sku_declared,
	jet(event_data, 'detailed_errors[different_pi_declared]') as different_pi_declared,
	...
	jet(event_data, 'detailed_errors[seller_whitelist]') as seller_whitelist,
	jet(event_data, 'detailed_errors[category_whitelist]') as category_whitelist,
