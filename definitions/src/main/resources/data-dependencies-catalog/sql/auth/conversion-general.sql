...
count(distinct (case when (c_hits_login > 0 and c_auth_success = 0 and c_auth_success_otp_rec = 0 and c_auth_success_otp_other = 0 and c_auth_failure = 0 and c_auth_failure_captcha = 0 and c_auth_failure_captcha_first = 0 and c_recovery = 0 and c_registration > 0 and c_banner = 0) then d2id else null end)) as c_reg_drop,
...
count(distinct (case when (c_hits_login > 0 and c_auth_success = 0 and c_auth_success_otp_rec = 0 and c_auth_success_otp_other = 0 and c_auth_failure = 0 and c_auth_failure_captcha = 0 and c_auth_failure_captcha_first = 0 and c_recovery = 0 and c_registration = 0 and c_banner > 0) then d2id else null end)) as c_ban_drop,
...
count(distinct (case when (c_hits_login > 0 and c_auth_success_otp_rec > 0 and c_recovery > 0) then d2id else git null end)) as c_login_recovery_succ,
count(distinct (case when (c_hits_login > 0 and c_auth_success_otp_other > 0 and c_registration > 0) then d2id else null end)) as c_login_reg_succ,
...
count(distinct (case when (c_hits_login > 0 and c_auth_success_otp_other > 0 and c_registration = 0 and c_recovery = 0) then d2id else null end)) as c_auth_otp_notrack_other
from (
	select
