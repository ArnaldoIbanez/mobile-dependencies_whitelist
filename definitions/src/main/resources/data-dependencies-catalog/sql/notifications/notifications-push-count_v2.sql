select count(*) as total, t.event_type as event_type, t.marketplace as marketplace, t.fecha AS ds from 
  ...
  and (
        ...
        or 
        (jet(event_data, 'event_type') in ('discarded') and jet(event_data, 'discard_reason') is null and jest(event_data, 'discard_reason') is null)
      )
  UNION ALL
  ...
  and (
        ...
        or 
        (jest(event_data, 'event_type') in ('discarded') and jet(event_data, 'discard_reason') is not null) and jest(event_data, 'discard_reason') is not null)
      ) 
