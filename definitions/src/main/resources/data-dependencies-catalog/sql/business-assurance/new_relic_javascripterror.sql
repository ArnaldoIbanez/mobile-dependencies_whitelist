...
lateral view json_tuple(data, 'eventType','applicationId','appName','deviceType','errorClass','errorMessage','requestUri','transactionName','userAgentName','userAgentOS','userAgentVersion') t1 
