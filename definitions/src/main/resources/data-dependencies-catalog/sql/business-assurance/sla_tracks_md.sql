SELECT
      allData.iniciativa    AS iniciativa,
      allData.section       AS section,
      allData.platform      AS platform,
      allData.version       AS version,
      allData.type          AS type,
      allData.path          AS path,
      allData.totalTracks   AS totalTracks,
      allData.validTracks   AS validTracks,
      allData.invalidTracks AS invalidTracks,
      allData.fecha         AS fecha
FROM(
