SELECT REGI.USERS AS user_id, REGI.SITE AS site, REGI.PLATFORM AS platform, REGI.APP AS app, REGI.SOURCE as source, REGI.FECHA as fecha_registracion, OTHERS.PATH AS primera_accion, OTHERS.FECHA AS fecha_primera_accion
FROM
