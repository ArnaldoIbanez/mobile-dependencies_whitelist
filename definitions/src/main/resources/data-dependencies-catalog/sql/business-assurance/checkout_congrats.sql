select 
  ...
  jest(event_data, 'resolution') as resolution,dsdssd   
  ...
  jest(event_data, 'available_subscription') as available_subscription,
  ...
  CAST(jest(event_data, 'items[0].unit_price_usd') as DOUBLE) as item_unit_price_usd,
