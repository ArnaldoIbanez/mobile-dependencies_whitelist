...
where ds >= '2017-02-24'
and ds < '2017-02-25' 
and path in ('/home','/notification_center','/vip','/search','/questions/answer/post','/notification/questions_new','/myml/suggested_discounts/review_discount/confirm','/myml/suggested_discounts/landing')
and device.platform in ('/mobile/android', '/mobile/ios')
and usr.user_id in (
  select distinct usr.user_id
  from tracks as t
  where t.ds >= '2017-02-25'
  and t.ds < '2017-02-26' 
