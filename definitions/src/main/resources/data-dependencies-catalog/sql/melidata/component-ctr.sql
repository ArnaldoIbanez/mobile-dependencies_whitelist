...
ON
    ...
    COALESCE(t1.component_order, -1) = COALESCE(t2.component_order, -1) AND
    COALESCE(t1.campaign, -1) = COALESCE(t2.campaign, -1) AND
    COALESCE(t1.brand_name, -1) = COALESCE(t2.brand_name, -1) AND
    COALESCE(t1.category_id, -1) = COALESCE(t2.category_id, -1)
