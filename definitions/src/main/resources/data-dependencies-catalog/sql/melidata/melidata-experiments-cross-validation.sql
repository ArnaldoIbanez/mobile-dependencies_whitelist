...
select 'BUCKETIZED_DATA' AS SOURCE, experiment_name, platform, cast(variant_id as string) variant_id, sum(valueb) as sessions, sum(valuea) as congrats, substr(ds,1,10) AS ds
