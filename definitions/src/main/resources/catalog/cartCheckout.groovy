...
/*
    propertyDefinitions {
        ...
        payment_splitted(required:false, type: PropertyType.Boolean, description: "Indica si hubo que splittear el pago")
        payments_quantity(required:false, type: PropertyType.Numeric, description: "Indica la cantidad de pagos (en una primer version de cart esto siempre va a ser 1)")
        bank(required:false, type: PropertyType.String, description: "Indica el banco seleccionado")
        payment_method(required:false, type: PropertyType.String, description: "Indica el metodo de pago seleccionado")
        payment_type(required:false, type: PropertyType.String, description: "Indica el tipo de pago seleccionado como ser credit_card, ticket, etc.")
        installments(required:false, type: PropertyType.Numeric, description: "Indica la cantidad de cuotas seleccionada")
        purchase_status(required:false, type: PropertyType.String, description: "Indica el status del pago en la congrats como ser pending, etc.")
    }

    propertyGroups {
        paymentStepGroup(precharged_cards, payment_splitted, payments_quantity, bank, payment_method, payment_type, installments)
        congratsStepGroup(purchase_status)
    }
*/
...
/*
    listing_type(required:false, type: PropertyType.String, description: "Indica el tipo de listing del item que se compra")
    international_delivery_mode(required:false, type: PropertyType.ArrayList, description: "Indica el tipo de envio internacional si es DDP o DDU")
    mercado_lider(required:false, type: PropertyType.String, description: "Indica si el vendedor del item es MercadoLider")
    reputation_level(required:false, type: PropertyType.String, description: "Indica la reputacion del vendedor")
    free_shipping_benefit(required:false, type: PropertyType.ArrayList, description: "Indica si se le aplica el beneficio de envio gratis por nivel de loyalty del comprador")
    resolution(required:false, type: PropertyType.String, description: "Indica si el flujo de compra lo renderiza como la version Low o High")
    loyalty_level(required:false, type: PropertyType.Numeric, description: "Indica el nivel de loyalty del comprador")
    is_empty(required:false, type: PropertyType.Boolean, description: "Indica si el carrito esta vacio")
    geolocated(required:false, type: PropertyType.Boolean, description: "Indica si se geolocalizo al usuario")
    packs_quantity(required:false, type: PropertyType.Numeric, description: "Indica la cantidad de paquetes del carrito") -> Esta no la enviamos a melidata porque la podemos inferir directamente
*/
}
...
// --> Ver si no deberia tener un /shipping
}
