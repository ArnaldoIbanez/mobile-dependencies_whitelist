...
tracks {
    ...
    "/wms/problem_solver/sub_flow"(platform: "/mobile/android", type: TrackType.View) {}

    /* Take sub flow */
    "/wms/problem_solver/sub_flow/start_take"(platform: "/mobile/android", type: TrackType.Event) {
        sub_flow(required: true, type: PropertyType.String, description: "Problem solver sub flow")
    }
