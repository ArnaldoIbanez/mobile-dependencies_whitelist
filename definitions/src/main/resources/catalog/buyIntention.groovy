...
"/buy_intention"(platform: "/",type: TrackType.Event) {
    ...
    checkout_flow(required: true, type: PropertyType.String, values: ["contract", "subscription", "direct"],  description: "The type of CHO that is starting by this buy intention. Reservation CHO's are excluded by the moment")
}
