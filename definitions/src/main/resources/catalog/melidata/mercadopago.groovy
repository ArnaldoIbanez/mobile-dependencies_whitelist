...
tracks {
    ...
    "/pos_mobile/friction"(platform: "/mobile", type: TrackType.Event) {
        ...
        style(required: false, type: PropertyType.String, description: "Style showed, window, dialog, toast.. ")
        message(required: false, type: PropertyType.String, description: "Message showed ")
        attributable_to(required: false, type: PropertyType.String, description: "User, Phone, Device, network or card")
