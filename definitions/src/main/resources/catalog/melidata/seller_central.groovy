...
tracks {
    ...
    "/seller_central/listings/list"(platform: "/", type: TrackType.View) {
      viewId(required:false, type: PropertyType.String, descritpion: "View that has been called")
    }
    ...
    "/seller_central/listings/communication"(platform: "/", type: TrackType.Event) {
        ...
        viewId(required:false, type: PropertyType.String, descritpion: "View where the event has been called")
    }
