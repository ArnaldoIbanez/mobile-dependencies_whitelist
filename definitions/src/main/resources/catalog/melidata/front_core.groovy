...
tracks {
    ...
    def banking_definition = objectSchemaDefinitions {
        partial_content(required: false, type: PropertyType.Boolean, description: "Contains whether if partial or not")
        default_content(required: false, type: PropertyType.Boolean, description: "Contains whether or not is the default content")
