...
tracks {
    ...
    "/bulk_payments/suppliers/init"(platform: "/", type: TrackType.View) {
      ...
      available_contacts(required:false, type:PropertyType.Numeric, description: "Available contacts in this step ")
