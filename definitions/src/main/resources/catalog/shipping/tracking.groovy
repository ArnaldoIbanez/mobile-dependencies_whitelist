...
tracks {
    ...
    def notification_payload_definition = objectSchemaDefinitions {
        ...
        cost(type: PropertyType.Numeric, required: false, description: "Shipment cost")
    ...
    def notification_definition = objectSchemaDefinitions {
        ...
        origin(type: PropertyType.String, required: false, description: "Notification origin",values: ["carrier-push", "carrier-pull", "meli", "shipping-back-office", "self-generated", "MELI-PUT", "MELI"])
