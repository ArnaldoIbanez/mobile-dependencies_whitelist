...
metrics {
        ...
        "deal_banner_shown"(description: "Search deal banner shown", acceptMultiVariantSession: true, deprecation_date:"2019/12/10") {
                startWith {
                        condition {
                                path("/search")
        ...
        "deal_banner_click"(description: "Search deal banner clicked", deprecation_date:"2019/12/10") {
                startWith {
        ...
        "deal_banner_after_click"(description: "After click search deal banner", acceptMultiVariantSession: true, deprecation_date:"2019/12/10") {
                startWith {
                        condition {
                                path("/search")
