...
tracks {
   ...
   "/insurtech/protections/detail/roda/feedback"(platform:"/", type: TrackType.Event, parentPropertiesInherited:false) {
    ...
    "insurtech/cards"(platform:"/", type: TrackType.View, parentPropertiesInherited:false){
        options(required: true, type: PropertyType.Map(card_protection_option), description: "Options objects")
    }
    ...
    "insurtech/cards/congrats_fail"(platform:"/", type: TrackType.View){
        options(required: true, type: PropertyType.Map(card_protection_option), description: "Option object")
    }
