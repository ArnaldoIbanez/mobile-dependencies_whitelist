...
tracks {
    ...
    "/wallet_home/home" (platform: "/mobile", type: TrackType.View) {
        ...
        advertising(required: false, type: PropertyType.Map(realestate_definition), description: "The cross_selling section information")
    ...
    "/wallet_home/section/tap/advertising" (platform: "/mobile", type: TrackType.Event, initiative: "1176") {
        walletHomeMerchEngineFields
    }
