...
tracks {
    ...
    "/flow"(platform: "/mobile", isAbstract: true) {
        flow_name(required: false, type: PropertyType.String, description: "Flow name generated by Traceability library")
    }
    ...
    "/flow/init"(platform: "/mobile", type: TrackType.Event) {
        ...
        sub_flow(required: false, type: PropertyType.String, description: "name of the subflow that has just started")
    }

    "/flow/end"(platform: "/mobile", type: TrackType.Event) {}

    "/flow/friction"(platform: "/mobile", isAbstract: true) {
        severity(required: false, type: PropertyType.String, description: "predefined severity of a friction")
        type(required: false, type: PropertyType.String, description: "defines a subtype of known problems that a flow faces")
    }

    "/flow/friction/networking"(platform: "/mobile", type: TrackType.Event) {
        connection_type(required: false, type: PropertyType.String, description: "Defines the type of connection the user is using")
        status(required: false, type: PropertyType.String, description: "describes the status code returned by the request")
        url(required: false, type: PropertyType.String, description: "requested service url")
    }

    "/flow/friction/system"(platform: "/mobile", type: TrackType.Event) {
        screen(required: false, type: PropertyType.String, description: "screen where the friction occurred")
        state(required: false, type: PropertyType.String, description: "application state at the time of friction")
        exception(required: false, type: PropertyType.String, description: "name of the exception that broke the application")
    }
    // Traceability  ------------>END
