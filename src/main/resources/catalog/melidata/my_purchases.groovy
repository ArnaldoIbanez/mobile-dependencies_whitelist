...
tracks {
    ...
    propertyDefinitions {
        ...
        pack_ids(required: false, type: PropertyType.ArrayList(String), description: "Pack ids involved in the purchase")
        order_ids(required: false, type: PropertyType.ArrayList(String), description: "Order ids involved in the purchase")
