...
tracks {
    ...
    "/kyc/iv/step_time"(platform: "/", type: TrackType.Event) {
        ...
        step_name(required: true, values: ["none", "permission", "landing", "landing_vanilla", "landing_error", "camera", "confirming", "uploading", "result"], type: PropertyType.String, description: "Step name")
    }
