...
tracks {
    ...
    "/kyc/iv/object_detection/validation"(platform: "/", type: TrackType.Event) {
        validation(required: true, values: ["error", "pending", "confidence", "aspect_ratio", "label_check", "denied_label_check", "brightness", "darkness", "blurry", "acceptance_matrix", "ok"], type: PropertyType.String, description: "Validation type")
        value(type: PropertyType.String, required: true, description: "Value of validation")
    }

    "/kyc/iv/object_detection/error"(platform: "/", type: TrackType.Event) {
