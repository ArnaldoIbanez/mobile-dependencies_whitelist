...
tracks {
    ...
    def itemExtraStructure = objectSchemaDefinitions {
      ...
      free_shipping(required: true, type: PropertyType.Boolean, description: "Inidcate wheter the item has free shipping")
      fulfillment(required: true, type: PropertyType.Boolean, description: "Inidcate wheter the item has fulfillment")
