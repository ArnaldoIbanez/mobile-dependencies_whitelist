...
tracks {
    ...
    propertyGroups {
        ...
        product_scan(item_id, scan_mode, items_total, items_found)
        scan_mode_data(scan_mode)
        product_weight_or_unit(item_id, scan_mode, measure, items_total)
        product_quantity(item_id, measure, items_total)
