...
tracks {
    ...
    def propertyLocationExtraInfo  = objectSchemaDefinitions {
        ...
        context(required: false, type: PropertyType.String, values: ["/instore/map", "/instore/map/location_button"], description: "Context from where permission landing was called")
    }
