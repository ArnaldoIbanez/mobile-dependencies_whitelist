...
tracks {
    ...
    "/asset_management/accepted_tyc"(platform: "/", type: TrackType.Event) {}
    ...
    //Chart events
    "/asset_management/tab_year"(platform: "/", type: TrackType.Event) {}
    "/asset_management/tab_month"(platform: "/", type: TrackType.Event) {}
    "/asset_management/previous_year"(platform: "/", type: TrackType.Event) {}
    ...
    "/asset_management/status_blocker/know_requirements"(platform: "/", type: TrackType.Event) {}
    "/asset_management/status_blocker/contact_bind"(platform: "/", type: TrackType.Event) {}
    "/asset_management/status_blocker"(platform: "/", type: TrackType.View) {
        status_id (required: false, type: PropertyType.String, description: "Status id", values: ["pending", "failed", "rejected", "banned"])
    }

    // blockerV2
    "/asset_management/blocker_v2/go_to_home"(platform: "/", type: TrackType.Event) {action (required: false)} 
    "/asset_management/blocker_v2/complete_data"(platform: "/", type: TrackType.Event) {action (required: false)}
    "/asset_management/blocker_v2/how_to_complete_data"(platform: "/", type: TrackType.Event) {action (required: false)}
    "/asset_management/blocker_v2/know_documentation"(platform: "/", type: TrackType.Event) {action (required: false)}
    "/asset_management/blocker_v2/know_requirements"(platform: "/", type: TrackType.Event) {action (required: false)}
    "/asset_management/blocker_v2/contact_bind"(platform: "/", type: TrackType.Event) {action (required: false)}
