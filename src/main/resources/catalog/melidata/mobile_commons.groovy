...
tracks {
    ...
    "/in_app_updates"(platform:"/mobile", isAbstract:true) {
        version(required:true, type:PropertyType.String, description:"v1 if bump legacy, v2 if in-app-update implemented", values:["v1", "v2"])
        type(required:true, type:PropertyType.String, description:"type of flow", values:["google_flexible", "google_immediate", "bump"])
        cause(required:false, type:PropertyType.String, description:"no reason for this")
    }
    ...
    "/in_app_updates/inactive/update_failed"(platform:"/mobile", type:TrackType.Event) {
        cause(required:true, type:PropertyType.String, description:"google reason of why didn't follow update flow")
    }
    "/in_app_updates/inactive/installed"(platform:"/mobile", type:TrackType.Event) {}
    "/in_app_updates/inactive/postponed"(platform:"/mobile", type:TrackType.Event) {}
