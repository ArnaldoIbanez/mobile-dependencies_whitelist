...
tracks {
    ...
    propertyDefinitions {
        ...
        seller_type(required: false, type: PropertyType.String, description: "Seller Type", values: ["branch", "brand", "car_dealer", "franchise", "normal","real_estate_agency"])
    }

    propertyGroups {
        creditGroup(vertical, seller_id, item_id, category_id, buyer_id, flow_type, bank, congrats_status, errors, seller_type, category_path)
    }
