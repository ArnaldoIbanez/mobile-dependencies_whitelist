...

  {
      ...
      def operation_definition = objectSchemaDefinitions {
          ...
          crypto(
                  ...
                  type: PropertyType.String,
                  required: true,
                  values: ["bitcoin", "ethereum","melicoin","usdp" ]
          )
          amount(
    ...
    //Crypto tracks
      ...
      "/crypto" (platform: "/mobile", type: TrackType.View) {
        user_profile(type: PropertyType.String, required: true, description: 'profile type for the current user')
      ...
      "/crypto/buy/insert_invalid_amount" (platform: "/mobile", type: TrackType.Event) {
        ...
        event_category(type: PropertyType.String, required: true, description: 'Category of event', values: ["crypto"])
        event_action(type: PropertyType.String, required: true, description: 'Action name of event', values: ["insert_invalid_amount"])
