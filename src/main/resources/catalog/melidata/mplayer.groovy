...
tracks {
    ...
    */
    ...
    "/funds_movements/new_transfer/search"(platform: "/mobile", type: TrackType.View) {}
    ...
    "/funds_movements/bottom_sheet/accounts"(platform: "/mobile", type: TrackType.Event) {
        total(required: true, type: PropertyType.Number, description: "Total number of accounts")
