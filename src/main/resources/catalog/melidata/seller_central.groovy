...
tracks {
    ...
    propertyDefinitions {
        ...
        item_type(required: true, type: PropertyType.String, description: "product: A PDP item, default: A normal item, associated_products: A normal item which has at least 1 variation that is associated  with a PDP item, associated_default: A PDP item associated with a normal item", values: ["product", "default", "associated_products", "associated_default"])
