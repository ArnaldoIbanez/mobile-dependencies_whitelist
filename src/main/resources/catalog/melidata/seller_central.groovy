...
tracks {
    ...
    "/seller_central/sales/fiscal-document/action"(platform: "/web", isAbstract: true, type: TrackType.Event) {}
    "/seller_central/sales/fiscal-document/action/secondary"(platform: "/web", isAbstract: true, type: TrackType.Event) {}
