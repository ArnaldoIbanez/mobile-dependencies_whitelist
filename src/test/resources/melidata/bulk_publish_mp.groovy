...
trackTests {
    ...
    test("seller central bulk publish download congrats view mp") {
        "/seller_central/bulk/publish/download/congrats"(platform: "/web", type: TrackType.View) {}
    }

    test("seller central bulk publish upload congrats view mp") {
        "/seller_central/bulk/publish/upload/congrats"(platform: "/web", type: TrackType.View) {}
    }

    test("seller central bulk publish download categories event mp") {
    ...
    test("seller central bulk publish show adults modal mp") {
        "/seller_central/bulk/publish/categories/adult/modal/show"(platform: "/web", type: TrackType.View) {
            adult = false
        }
    }

    test("seller central bulk publish cancel adults modal mp") {
    ...
    test("seller central bulk publish confirm adults modal mp") {
        "/seller_central/bulk/publish/categories/adult/modal"(platform: "/web", type: TrackType.Event) {
            action = "confirm"
            adult = false
        }
