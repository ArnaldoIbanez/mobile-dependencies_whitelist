...
trackTests {
    ...
    test("Email") {
        ...
        "/profile/email/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            status = "verified"
    ...
    test("phone") {
        ...
        "/profile/phone/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            registered_by_phone = true
    ...
    test("Alternative phone") {
        ...
        "/profile/alternative_phone/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            registered_by_phone = true
    ...
    test("Contact phone") {
        ...
        "/profile/contact_phone/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            registered_by_phone = true
    ...
    test("Preferred name") {
        ...
        "/profile/preferred_name/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            status = "verified"
    ...
    test("User name") {
        ...
        "/profile/user_name/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            status = "verified"
    ...
    test("Identity") {
        ...
        "/profile/identity/edit"(platform: "/", type: TrackType.Event) {
            entity_type = "person"
            is_compliant = true
            user_type = "CO"
            access = "full"
