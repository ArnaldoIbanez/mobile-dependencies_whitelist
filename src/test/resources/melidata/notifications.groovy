...
trackTests {
    ...
    test("Mobile Notifications mercadolibre"){
        ...
        "/notification_center/money_in_cashin_accredited"(platform: "/mobile") {
            latest_news_id= "money_in_cashin-186785675-76283123"
            latest_news_type= "money_in_cashin_accredited"
        }
        "/notification_center/money_in_cashin_rejected"(platform: "/mobile") {
            latest_news_id= "money_in_cashin-186785675-76283123"
            latest_news_type= "money_in_cashin_rejected"
        }
        ...
        "/notification/money_in_cashin_accredited"(platform: "/mobile") {
            news_id = "money_in_cashin-1004906131-ACAVAUNHASHRELINDOYRELOCO"
            event_type = "open"
        }
        "/notification/money_in_cashin_rejected"(platform: "/mobile") {
            news_id = "money_in_cashin-1004906131-ACAVAUNHASHRELINDOYRELOCO"
            event_type = "open"
        }
        "/notification/money_request_started"(platform: "/mobile"){
