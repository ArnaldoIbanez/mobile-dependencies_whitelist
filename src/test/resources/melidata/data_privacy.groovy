...
trackTests {
  ...
  test("data_privacy") {
    // Mercadolibre
    "/landing_data_privacy"(platform: "/web", business: "mercadolibre") {}
    "/landing_data_privacy/event/click"(platform: "/web", business: "mercadolibre") {
    ...
    "/landing_data_privacy/event/scroll"(platform: "/web", business: "mercadolibre") {
      text = "Responsabilidad sobre los datos"
      component = "view"
    }
    "/landing_data_privacy/event/hover"(platform: "/web", business: "mercadolibre") {
