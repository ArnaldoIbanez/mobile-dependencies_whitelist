...
trackTests {
    ...
    test ("Hybrid Setup") {
        "/hybrid/detail" (platform: "/web/desktop") {}
        "/cards/hybrid-detail/download-app" (platform: "/web/desktop") {}
        "cards/hybrid-detail/send-sms" (platform: "/web/desktop") {}
        "/cards/hybrid-detail/click-send-message" (platform: "/web/desktop") {}
    }
}
